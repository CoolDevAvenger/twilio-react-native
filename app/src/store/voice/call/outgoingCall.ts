...
>(
  ...
  async (
    ...
    console.log("makeOutgoingCall", recipientType, to);
    ...
    outgoingCall.on(TwilioCall.Event.Ringing, () => {
      // The call is now connected, you can access its properties
      const callInfo = getCallInfo(outgoingCall);
